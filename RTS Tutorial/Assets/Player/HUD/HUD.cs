...
public class HUD : MonoBehaviour {
	...
	void Start () {
		...
		Debug.Log("build are height : " + buildAreaHeight);
	...
	/// <summary>
	/// Checks if mouse is in the bounds.
	/// </summary>
	/// <returns><c>true</c>, if in mouse is inside the bounds, <c>false</c> otherwise.</returns>
	...
	/// </summary>
	/// <returns>The playing area.</returns>
	public Rect GetPlayingArea() {
		return new Rect(0, RESOURCE_BAR_HEIGHT, Screen.width - ORDERS_BAR_WIDTH, Screen.height - RESOURCE_BAR_HEIGHT);
	}

	/// <summary>
	/// Sets the resource values.
	/// </summary>
	/// <param name="resourceValues">Resource values.</param>
	/// <param name="resourceLimits">Resource limits.</param>
	...
	/// <summary>
	/// Gets the state of the previous cursor.
	/// </summary>
	/// <returns>The previous cursor state.</returns>
	public CursorState GetPreviousCursorState() {
		return previousCursorState;
	}

	/// <summary>
	/// Gets the state of the active cursor.
	/// </summary>
	/// <returns>The active cursor state.</returns>
